      ...
      <div class="cart-icon">
        <svg 
          ...
          <g 
            ...
            fill-rule="evenodd" 
            filter="url(#a)" 
            transform="translate(10.3 12)">
            <path 
              stroke="#979797" 
              stroke-width="6" 
              d="M22.9 9.6a3 3 0 0 0-3 3.8l5.2 20.4a3 3 0 0 0 3 2.2h46.7a3 3 0 0 0 2.7-1.6L87.7 14A3 3 0 0 0 85 9.6H22.9z"/>
            <g 
              fill="#979797" 
              fill-rule="nonzero">
            ...
            <path 
              ...
              stroke-width="6" 
              d="M0 0h13.7c1 0 1.8.7 2 1.6L23 38l-3.5 14.3H79"/>
            <g fill-rule="nonzero">
              <use 
                fill="#000" 
                filter="url(#b)" 
        ...
        <span 
          v-if="cartHasItems" 
          class="cart-counter">{{ this.cartContents.length }}</span>
      </div>
    </router-link>
    <button 
