  ...
  <div 
    ...
    <svg 
      ...
      <defs>
        ...
        <linearGradient :id="uniqueId" x1="50%" x2="50%" y1="0%" y2="100%">
        ...
        <mask :id="bottleOutlineId" fill="#fff">
          <path id="path-2" d="M 35.33 0 C 35.33 23.66 0 13.14 0 43.38 L 0 187.44 C 0 200.59 106 199.8 106 186.65 L 106 43.38 C 106 13.14 70.67 23.66 70.67 0 L 35.33 0 Z"/>
        </mask>
      ...
      <g id="juice-bottle" fill="none" fill-rule="evenodd">
        <g id="bottle" filter="url(#filter-1)" transform="translate(12 22)" v-bind:mask="'url(#' + bottleOutlineId + ')'" >
          <use id="bottle-outline" fill="#D8D8D8" fill-rule="nonzero"
          ...
          <path id="Juice-Color" :fill="'url(#'+ uniqueId +')'" fill-rule="nonzero" d="M-3.9 20.5h115.2v180.1H-3.9z" />
          <g id="Glass-sheen" fill-rule="nonzero" >
...
export default {
  ...
  computed: {
    ...
    bottleOutlineId: function() {
      ...
      return "bottle-outline" + this.juiceName.replace(/\s/g, "_") + Math.floor(Math.random() * 1000 + 1);
    },
  ...
  methods: {
    ...
    resize: function() {
      ...
      // console.log(bottleOutline);

      const largeSize = {
        path: "M 35.33 0 C 35.33 23.66 0 13.14 0 43.38 L 0 187.44 C 0 200.59 106 199.8 106 186.65 L 106 43.38 C 106 13.14 70.67 23.66 70.67 0 L 35.33 0 Z",
        lidY: "37",
        labelY: "75.4"
      };
      const mediumSize = {
        path: "M 35.33 0 C 35.33 23.66 10.576 19.215 10.576 49.455 L 10.576 187.929 C 10.576 201.079 95.184 201.079 95.184 187.929 L 95.184 49.455 C 95.184 19.215 70.67 23.66 70.67 0 L 35.33 0 Z",
        lidY: "37",
        labelY: "75.4"
      };
      const smallSize = {
        path: "M 35.544 47.45 C 35.544 66.613 10.576 70.407 10.576 94.9 L 10.576 187.929 C 10.576 198.58 95.184 198.58 95.184 187.929 L 95.184 94.9 C 95.184 70.407 71.088 66.613 71.088 47.45 L 35.544 47.45 Z",
        lidY: "45",
        labelY: "100"
      }
