          ...
          <g id="Juice-bottle-with-label" transform="translate(12 11)">
            <g id="Juice-bottle" filter="url(#filter-1)">
              <g id="Group" transform="translate(0 11.83)">
                ...
                <g id="Orange-Juice" :fill="'url(#'+ uniqueId +')'" fill-rule="nonzero" mask="url(#mask-3)">
                ...
                <g id="Logo-type-Copy-3">
                  <g id="Logo-Copy-4">
                    <g id="Fruit" transform="translate(2.86 8.7)">
                      ...
                      <path id="Path-3-Copy-3" fill="#A9A9A9" fill-rule="nonzero" d="M15.1-4.68C10.37-5.95 7.58.4 9.8 5.64 15.84 4 17.57-2.64 15.1-4.68z" mask="url(#mask-10)" style="mix-blend-mode:multiply"/>
                      <path id="Path-3-Copy-4" fill="#A9A9A9" fill-rule="nonzero" d="M1.75 1.4c-4.08 0-6.05 6.17-2.47 10.24C2.98 7.95 4.46 2.73 1.75 1.4z" mask="url(#mask-10)" style="mix-blend-mode:multiply"/>
...
export default {
  ...
  computed: {
    uniqueId() {
      ...
      const juiceComputedId = this.juiceName.replace(/\s/g, "_") + Math.floor((Math.random() * 100) + 1);
